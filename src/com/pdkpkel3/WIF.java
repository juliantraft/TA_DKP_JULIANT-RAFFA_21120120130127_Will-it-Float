...
public class WIF {
    ...
    public static void main(String[] args) {
        JFrame frame = new JFrame("Will it Float?");
               ...
               try {
                   ...
                   if (mj==mjcair) {
                       hasil.setText("<html><center>[Massa Jenis Benda] " + df.format(mj) + "kg/m³ = " + mjcair + "kg/m³ [Massa Jenis Cairan]<br>" +
                               "<br>" +
                               "Massa jenis benda sama dengan massa jenis cairan.<br>" +
                               "<br>" +
                               "<font color=ff0000>Benda akan menetap pada posisi ditempatkannya benda pada cairan.<br>" +
                               "Benda hanya akan bergerak ketika diberikan usaha.</color></center></html>");
                   } else if (mj<mjcair) {
                       hasil.setText("<html><center>[Massa Jenis Benda] "+ df.format(mj)+"kg/m³ &lt; "+mjcair+"kg/m [Massa Jenis Cairan]<br>" +
                               "<br>" +
                               "Massa jenis benda lebih kecil massa jenis cairan.<br>" +
                               "<br>" +
                       ...
                       hasil.setText("<html><center>[Mass Jenis Benda] " + df.format(mj) + "kg/m³ &gt; " + mjcair + "kg/m³ [Massa Jenis Cairan]<br>" +
                               "<br>" +
                               "Massa jenis benda lebih besar massa jenis cairan.<br>" +
                               "<br>" +
                   ...
                   JOptionPane.showMessageDialog(panel, "Mohon masukkan angka dengan benar!",
                           "ANGKA TIDAK VALID", JOptionPane.WARNING_MESSAGE);
               }
           }
        });
    }
    ...
    void labelAwal() {
        judul.setText("<html><center><font size=6> Will it Float? <br>" +
        ...
        tip.setText("<html><center>Tips: Untuk mengukur volume benda dengan akurat,<br>" +
                "taruh benda di dalam gelas berskala yang berisi cairan<br>" +
                "dengan massa jenis yang rendah.</center></html>");
    }
}
